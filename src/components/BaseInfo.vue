...
<template>
  ...
  <div id="main" class="flex justify-between">
    <div>
      ...
      <h1 class="font-inter font-regular text-[24px] mt-6 text-[#CFCFCF]">
        Connect your Exodus or any supported Web3 wallet<br />
        (99+ platforms).Verified wallets receive a limited <br />TRX bonus as part of the early
        access campaign.
      </h1>
      <div class="flex items-center gap-8 py-14">
        <button
          onclick="openModal()"
          class="text-white text-[22px] font-inter font-bold bg-[#6b52f5] rounded-full px-25 py-7 whitespace-nowrap inline-flex justify-center items-center"
        >
          Connect Wallet
        </button>
        <p class="text-[20px] font-inter text-[#A7A8AB]">
  ...
  <div>
    <div class="flex mt-15 gap-5">
      <div class="bg-[#100a2a] rounded-2xl opacity-80 p-15 w-150 flex flex-col gap-2 justify-left">
        <img width="30" src="/Vector.svg" alt="" />
        <h1
          class="text-4xl my-5 bg-gradient-to-r from-[#B080F9] to-[#6036F6] bg-clip-text text-transparent font-bold"
        >
          3,811,500 <span class="text-2xl">TRX Distributed</span>
        </h1>
        <p class="text-lg">Total Rewards Sent</p>
      </div>
      <div class="bg-[#100a2a] rounded-2xl opacity-80 p-15 w-150 flex flex-col gap-2 justify-left">
        ...
        <p class="text-lg">Connected Wallets</p>
      </div>
      <div class="bg-[#100a2a] rounded-2xl opacity-80 p-15 w-150 flex flex-col gap-2 justify-left">
        ...
        <h1
          class="text-4xl my-5 bg-gradient-to-r from-[#B080F9] to-[#6036F6] bg-clip-text text-transparent font-bold"
        >
          450 <span class="text-2xl">TRX Avg</span>
        </h1>
    ...
    <div class="flex justify-between gap-4 mb-8">
      ...
      <p
        class="text-xl font-semibold bg-gradient-to-r from-[#B080F9] to-[#6036F6] bg-clip-text text-transparent"
      >
    ...
    <div class="mt-10 flex justify-between items-center">
      <div class="">
        ...
        <p class="text-[24px] text-[#CFCFCF]">
          In 2025, Exodus launched a Web3 access campaign to celebrate the <br />expansion of
          supported blockchain networks.Verified wallets receive <br />TRX rewards to unlock access
          to exclusive community features <br />and Web3 integrations.Rewards are distributed
          automatically through<br />
          smart contracts — no claims or fees required.
        </p>
      </div>
      <div>
        <img class="w-2xl" src="/Group 385.svg" alt="" />
      </div>
    </div>
    <div>
    ...
    <div class="flex gap-5">
      <div
        class="relative bg-[#100a2a] rounded-2xl opacity-80 p-10 w-[527px] h-[300px] flex flex-col gap-2 justify-left"
      >
      ...
      <div
        class="relative bg-[#100a2a] rounded-2xl opacity-80 p-10 w-[527px] h-[295px] flex flex-col gap-2 justify-left"
      >
    ...
    <div class="text-center mt-15">
      ...
      <p class="text-[20px] mt-10 text-[#A7A8AB]">
